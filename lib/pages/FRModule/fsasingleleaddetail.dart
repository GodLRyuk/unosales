...
class FsaSingleAssignLead extends StatefulWidget {
  final String leadId;
  const FsaSingleAssignLead(
      {super.key, required this.leadId});

  @override
  State<FsaSingleAssignLead> createState() => _FsaSingleAssignLeadState();
}

class _FsaSingleAssignLeadState extends State<FsaSingleAssignLead> {
  bool isLoading = true;
            ...
            leading: IconButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => AssignedLeads(searchQuery: '',
