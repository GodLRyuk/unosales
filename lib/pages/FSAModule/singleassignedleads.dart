...
class FSASingleAssignedLead extends StatefulWidget {
  final String leadId;
  const FSASingleAssignedLead(
      {super.key, required this.leadId});

  @override
  State<FSASingleAssignedLead> createState() => _FSASingleAssignedLeadState();
}

class _FSASingleAssignedLeadState extends State<FSASingleAssignedLead> {
  bool isLoading = true;
